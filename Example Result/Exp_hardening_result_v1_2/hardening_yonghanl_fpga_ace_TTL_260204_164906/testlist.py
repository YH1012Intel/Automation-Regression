...
dspmem_50_1 = {'job': 'dspmem_50_1', 'type': 'perspec_maestro', 'feature_list' :['dspmem'], 'args': [{'content_location': r'perspec/targets/ipsv/ace/fpga/dsp_all_cores/dspmem_50_imr.sln', 'maestro_tags': maestro_tags, 'perspec_files': perspec_files, 'perspec_args': perspec_args, 'perspec_seed': 13988, 'perspec_seed_count': 1, 'maestro_seed_count': 50}]}
